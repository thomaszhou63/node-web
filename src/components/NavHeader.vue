        ...
        <div class="navbar">
            ...
            <div class="navbar-right-container" style="display: flex;">
              <div class="navbar-menu-container">
                ...
                <!--<span class="navbar-link"  v-if="nickName">eee</span>-->
...
//                      }
            ...
            login(){///////////////////////登入
                if(!this.userName || !this.userPwd){ // 先校验账号、密码
                  this.errorTip = true;
                  return;
                }
                axios.post("/users/login",{
                  ...
                  userPwd:this.userPwd
                    ...
                    if(res.status == '0'){
                      ...
                      this.$router.replace(this.currentPath); // 登录成功就返回到goods界面
